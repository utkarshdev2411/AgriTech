...
const Login = () => {
  ...
  return (
    <div className="relative min-h-[88vh] bg-gradient-to-b from-[#e8f5df] via-[#f0f9f1] to-[#e8f5ea] overflow-hidden">
      {/* Background patterns and decorative elements */}
      <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
      
      {/* Floating elements - Enhanced farm theme */}
      <div className="absolute w-full h-full pointer-events-none">
        <div className="absolute top-[10%] left-[5%] text-green-300 opacity-20 animate-float-slow">
          <GiWheat size={30} />
        </div>
        <div className="absolute top-[20%] right-[8%] text-amber-300 opacity-20 animate-float-medium">
          <FaSeedling size={25} />
        </div>
        <div className="absolute bottom-[15%] left-[12%] text-green-300 opacity-20 animate-float-fast">
          <GiPlantSeed size={20} />
        </div>
        <div className="absolute bottom-[25%] right-[7%] text-blue-200 opacity-20 animate-float-slow">
          <FaWind size={20} />
        </div>
        <div className="absolute top-[50%] left-[20%] text-green-300 opacity-20 animate-float-medium">
          <PiPlantFill size={25} />
        </div>
        <div className="absolute top-[30%] right-[15%] text-amber-400 opacity-20 animate-float-slow">
          <GiCorn size={28} />
        </div>
        <div className="absolute bottom-[40%] left-[8%] text-green-400 opacity-20 animate-float-medium">
        ...
        <div className="w-full md:w-1/2 mb-10 md:mb-0 flex justify-center items-center">
          <div className="w-full max-w-md">
            <div className="text-center mb-6">
              ...
              <h1 className="text-3xl font-bold text-slate-800 mb-2">Welcome to AgriTech</h1>
              <p className="text-slate-600">Sign in to cultivate success with smart farming</p>
            </div>
