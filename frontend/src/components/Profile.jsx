...
function Profile() {
  ...
  return (
    ...
    <div className="flex justify-center ">
        <div className="flex justify-center items-center bg-gray-200 shadow-2xl flex-col border border-[#242535] rounded-lg m-4 w-full py-8 max-w-2xl">
          ...
          {userInfo.bio && (
            <div className="w-[75%] max-w-2xl text-center py-3">{userInfo.bio}</div>
          )}
